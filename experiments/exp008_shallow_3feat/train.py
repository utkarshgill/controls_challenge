"""
exp008: Shallow network (3 features, 1 hidden layer with 16 units)
State: [error, error_integral, error_derivative]
Network: Linear(3, 16) -> Tanh -> Linear(16, 1)
"""
import os
import sys
import time
...
def train():
    print("=" * 60)
    print("EXP008: Shallow Network (3 features)")
    print("State: [error, error_integral, error_derivative]")
    print("Network: Linear(3, 16) -> Tanh -> Linear(16, 1)")
    print("=" * 60)
    ...
    actor_critic = ShallowActorCritic(state_dim=3, action_dim=1, hidden_size=16).to(DEVICE)
