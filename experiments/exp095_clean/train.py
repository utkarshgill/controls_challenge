# exp095 — Clean refactor of exp055 with train_one_epoch abstraction
#
# Functionally identical to exp055. Same architecture, same PPO, same rollout.
# Just reorganized into:
#   TrainingContext — holds all state
#   train_one_epoch(epoch, ctx) — one epoch: rollout → update → log → eval
#   train() — thin wrapper that loops over epochs
