"""
Experiment 014: PPO Fine-Tuning from BC (Version 4 - ULTRA CONSERVATIVE)

V4 CHANGES:
1. MUCH lower LR: 3e-5 (10x lower than V3)
2. Smaller clip: 0.1 (was 0.2)
3. Only 2 PPO epochs (was 4)
4. Early stopping when cost increases
5. Save checkpoints every 5 iterations

V3 proved we CAN hit <45 (min=11.03!) but training is unstable.
V4: Be VERY gentle, don't break the good policy.
"""
import sys
...
NUM_EPOCHS_PPO = 2              # ONLY 2 epochs - minimal updates

LEARNING_RATE = 3e-5            # ULTRA low LR - be VERY gentle
GAMMA = 0.99                    # Discount factor
GAE_LAMBDA = 0.95               # GAE parameter
CLIP_EPSILON = 0.1              # SMALLER clip - stay very close to old policy
...
def main():
    print("="*80)
    print("Experiment 014: PPO Fine-Tuning (V4 - ULTRA CONSERVATIVE)")
    print("="*80)
