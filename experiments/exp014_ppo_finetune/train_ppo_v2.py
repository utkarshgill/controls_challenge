"""
Experiment 014: PPO Fine-Tuning from BC (Version 2 - Official Simulator)

Uses official TinyPhysicsSimulator for rollouts to guarantee perfect match with evaluation.
Architecture: Controller-based policy → Official rollout → PPO updates
"""
import sys
...
NUM_EPOCHS_PPO = 10             # PPO update epochs per batch
        ...
        with torch.no_grad():
            ...
            if self.collect_data:
                ...
                if self.prev_lataccel is not None:
                    ...
                    step_cost = lat_error * 5000 + jerk * 100
...
def main():
    print("="*80)
    print("Experiment 014: PPO Fine-Tuning (V2 - Official Simulator)")
    print("="*80)
    ...
    for iteration in trange(NUM_ITERATIONS, desc="Training"):
        ...
        tqdm.write(f"Iter {iteration:3d} | Cost: {mean_cost:7.2f} | "
