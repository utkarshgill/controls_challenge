# exp091 — PPO with MPC rollout policy
#
# Surgical patch on exp055: replace Beta sampling in rollout with
# per-step shooting MPC (K candidates, H-step lookahead, Gaussian σ).
# MPC uses the same TRT session via BatchedPhysicsModel.
# PPO trains on the MPC's trajectories. Policy learns from MPC's choices.
# Eval uses deterministic policy mean (no MPC).
