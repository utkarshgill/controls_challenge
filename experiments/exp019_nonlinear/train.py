...
# Network: 9D input -> 64 -> 64 -> 1D output
net = nn.Sequential(
    nn.Linear(9, 64),
    nn.Tanh(),
    nn.Linear(64, 64),
...
# Save model
torch.save({'model_state_dict': net.state_dict()}, 'experiments/exp019_nonlinear/model.pth')
print("✅ Model saved")
...
print(f"exp019 (non-linear):  Train={train_cost:.2f}, Val={val_cost:.2f}, Test={test_cost:.2f}")
