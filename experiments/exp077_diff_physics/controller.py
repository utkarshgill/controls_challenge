# exp077 — Clean inference controller
# Identical to exp055 controller. No differentiable physics at test time.
# The TBPTT training only changes the weights, not the architecture.
