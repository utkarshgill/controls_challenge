"""
Train behavioral cloning network on PID trajectories
Network outputs μ (mean) with learnable log_std
"""
import sys
sys.path.insert(0, '../..')
...
def train():
    print("="*60)
    print("Training Behavioral Cloning from PID")
    print("="*60)
    
    # Load data
    print("\nLoading data...")
    with open('pid_trajectories_v3.pkl', 'rb') as f:
        data = pickle.load(f)
