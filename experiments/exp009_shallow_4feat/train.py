"""
exp009: Shallow network (4 features: add v_ego)
State: [error, error_integral, error_derivative, v_ego]
Network: Linear(4, 16) -> Tanh -> Linear(16, 1)
"""
import os
import sys
import time
...
def train():
    print("=" * 60)
    print("EXP009: Shallow Network (4 features)")
    print("State: [error, error_integral, error_derivative, v_ego]")
    print("Network: Linear(4, 16) -> Tanh -> Linear(16, 1)")
    print("=" * 60)
    ...
    actor_critic = ShallowActorCritic(state_dim=4, action_dim=1, hidden_size=16).to(DEVICE)
